...
public class ContractServiceImpl implements ContractService {
    ...
    public ApiResponse<CompareAnalysisResponse> queryAnalysis(Long userId) {
        ...
        wrapper4.lambda().and(wp -> wp.eq(CContractRecord::getCompareState, CompareStateEnum.HANDLING)
                .or()
    ...
    @Override
    public ApiResponse<List<CompareAnalysisChartResponse>> queryAnalysisChart(CompareAnalysisQuery query) throws ParseException {
