...
import com.jsnjwj.facade.mapper.GameJudgeItemMapper;
import com.jsnjwj.facade.mapper.GameJudgeMapper;
...
public class GameJudgeManager {
    ...
    @Resource
    private GameJudgeMapper gameJudgeMapper;

    @Resource
    private GameJudgeItemMapper gameJudgeItemMapper;
